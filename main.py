...
def dibujar_figuras(color=BLANCO):
    for fil in range(FILS):
        for col in range(COLS):
            if board[fil][col] == 1:
                pygame.draw.circle(screen, color, (int(col * TAM_CUADRICULA + TAM_CUADRICULA // 2), int(fil * TAM_CUADRICULA + TAM_CUADRICULA // 2)), RADIO_CIRCULO, ANCHO_CIRCULO)
            elif board[fil][col] == 2:
                pygame.draw.line(screen, color, (col * TAM_CUADRICULA + TAM_CUADRICULA // 4, fil * TAM_CUADRICULA + TAM_CUADRICULA // 4), (col * TAM_CUADRICULA + 3 * TAM_CUADRICULA // 4, fil * TAM_CUADRICULA + 3 * TAM_CUADRICULA // 4), ANCHO_X)
                pygame.draw.line(screen, color, (col * TAM_CUADRICULA + TAM_CUADRICULA // 4, fil * TAM_CUADRICULA + 3 * TAM_CUADRICULA // 4), (col * TAM_CUADRICULA + 3 * TAM_CUADRICULA // 4, fil * TAM_CUADRICULA + TAM_CUADRICULA // 4), ANCHO_X)
